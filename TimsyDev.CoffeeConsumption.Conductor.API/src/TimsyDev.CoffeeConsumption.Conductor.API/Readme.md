...
Execute unit tests
```
    cd "TimsyDev.CoffeeConsumption.Conductor.API/test/TimsyDev.CoffeeConsumption.Conductor.API.Tests"
    dotnet test
```

Deploy application
```
    cd "TimsyDev.CoffeeConsumption.Conductor.API/src/TimsyDev.CoffeeConsumption.Conductor.API"
